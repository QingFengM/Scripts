...
//直播间标题栏修改样式
    ...
    css += '.header-info-ctnr .closedown-left .initiator-ctnr .initiator-name {font-size: 14px !important;margin-left: 8px !important;}';//标题栏字体大小
    ...
    css += '.initiator-label.live-skin-normal-a-text {display: none !important;}';//删除发起者:文本标签
    css += '.status-tag {display: none !important;}';//删除未开播
    css += '.live-title .icon-a-bubble_comment_linepinglun {display: none !important;}';//删除对话气泡图标
